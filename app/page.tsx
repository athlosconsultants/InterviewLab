      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(to bottom, transparent 0%, transparent 40%, rgba(224, 242, 254, 0.3) 60%, rgba(224, 242, 254, 0.7) 80%, rgb(224, 242, 254) 100%)'
            }}
          />
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm">
              <div className="flex items-center gap-2 text-slate-700 drop-shadow-sm">
                ...
                <span className="font-medium">AI trained on 10,000+ S&P 500 interviews</span>
              </div>
              <div className="flex items-center gap-2 text-slate-700 drop-shadow-sm">
